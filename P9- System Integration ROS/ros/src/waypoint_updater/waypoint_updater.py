...
class WaypointUpdater(object):
    ...
    def loop(self):
        ...
        while not rospy.is_shutdown():
            ...
            #     self.publish_waypoints(closest_waypoint_idx) #closest_waypoint_idx
            rate.sleep()
    ...
    def publish_waypoints(self):
        final_lane = self.generate_lane() #Update waypoints based on TL information
        self.final_waypoints_pub.publish(final_lane) # Call the Publisher
